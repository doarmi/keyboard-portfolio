...
> 서비스 기획 · UI/UX 디자인 · 인터랙티브 웹 구현을 중심으로 작업한 안효진의 개인 웹 포트폴리오입니다.

## About Me

안녕하세요. 사용자 흐름을 설계하고 아이디어를 구체화해  
실제로 작동하는 디지털 경험으로 만드는 **안효진**입니다.

서비스 기획과 UI/UX 디자인을 바탕으로 아이디어를 화면으로 설계하고,
React · TypeScript · AI 기반 개발 도구를 활용해 직접 구현하는 과정까지 경험하고 있습니다.

단순히 화면을 디자인하는 것에 그치지 않고,
**사용자가 어떤 흐름으로 서비스를 경험하는지 고민하고 이를 실제 웹으로 구현하는 것**을 중요하게 생각합니다.
